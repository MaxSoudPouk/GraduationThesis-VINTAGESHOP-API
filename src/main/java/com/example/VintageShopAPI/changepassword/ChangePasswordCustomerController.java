...
@RestController
@CrossOrigin
public class ChangePasswordCustomerController {
    public static HttpServletRequest request;
    DatabaseConnectionPool dbConnectionPool;


    private void setRequest(HttpServletRequest request) {
        ChangePasswordCustomerController.request = request;

    }

    @PostMapping("/v1/ChangePasswordCustomer")
...
//=========================== DB ===========================//
            ...
            String sql = "UPDATE customer_tb SET customer_password = ?, customer_date_time = ? WHERE customer_id = ? and customer_password = ?";
            String sqlpassword = "SELECT customer_password from customer_tb where customer_id = '"
                    + customer_ID + "'  LIMIT 1";
            ...
            if (jwtencoderesult) {
                ...
                try {
                    ...
                    if (rs != null && rs.next()) {
                        customer_qry_password = rs.getString("customer_password");
