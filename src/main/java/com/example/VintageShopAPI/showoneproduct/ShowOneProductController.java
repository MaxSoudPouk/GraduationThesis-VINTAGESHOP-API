package com.example.VintageShopAPI.showoneproduct;
...
@RestController
@CrossOrigin
public class ShowOneProductController {
...
//        if (jwtencoderesult) {
            ...
            try {
                ...
                statement.setString(1, productIDShow);
                ...
                while (resultSet.next()) {
                    ...
                    product_detail.put("CategoryName", String.valueOf(categoryName));
