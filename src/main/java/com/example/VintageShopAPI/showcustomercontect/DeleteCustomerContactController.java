...
@RestController
@CrossOrigin
public class DeleteCustomerContactController {

    @PostMapping("/v1/DeleteCustomerContact")
    public ResponseEntity<Map<String, Object>> AddProduct(
        ...
        if (messageID.equals("") || token.equals("") || user_Email.equals("") || user_ID.equals("")) {
...
//=========================== DB ===========================//
        ...
        String sql = "UPDATE customer_message\n" +
                "SET message_status_delete = '0', message_delete_date = '"+datepro111+"' \n" +
